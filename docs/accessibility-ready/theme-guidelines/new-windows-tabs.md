...
contributors:
   ...
   - Joe Dolson
redirect_from:
   - /docs/topics/theme-guidelines/new-windows-tabs/
---
...
[Link destinations]({{site.baseurl}}/docs/topics/content/links/link-destinations/) in Standards and best practice, Content and Images.
