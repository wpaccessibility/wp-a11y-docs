...
The [WordPress theme accessibility guidelines]({{site.baseurl}}/docs/accessibility-ready/theme-guidelines/), including testing instructions, so you can check your own theme.
