...
description: What you should put into an accessibility statement.
nav_order: 1
---
...
An accessibility statement is not an audit report or an [Accessibility Conformance Report (ACR).]({{site.baseurl}}/docs/topics/documenting-accessibility/acr/) Instead, it’s a shorter document or more designed page that provides transparency, helps set expectations, and indicates a path for support. 
...
* [W3C accessibility statement generator](https://www.w3.org/WAI/planning/statements/generator/#create)
* [Gov.uk public sector accessibility statement template](https://www.gov.uk/government/publications/sample-accessibility-statement) (UK-specific legal format)
* [European Commission model accessibility statement](https://eur-lex.europa.eu/eli/dec_impl/2018/1523/oj/eng) under the EU Web Accessibility Directive.
