...
- Please enter you email address, so we can send you the confirmation of your appointment.
...
Writing clear error message texts that explaining what went wrong is required to meet the following WCAG success criteria:
