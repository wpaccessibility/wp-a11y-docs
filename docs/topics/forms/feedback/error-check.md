...
- For more information about the drawbacks of native HTML form validation, read [The problem with live validation and what to do instead](https://adamsilver.io/blog/the-problem-with-live-validation-and-what-to-do-instead/) by Adam Silver.
- Native HTML form validation still has accessibility issues in 2026, please read [HTML form validation]({{site.baseurl}}/docs/topics/forms/feedback/html-form-validation/) for more context.
