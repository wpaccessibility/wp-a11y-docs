...
How to do this is described in the guideline [Place descriptions between label and form field]({{site.baseurl}}/docs/topics/forms/descriptions/location-description/).
