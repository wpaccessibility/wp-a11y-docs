...
{: .callout .info }
**Note:** The use of `aria-invalid` is addressed in [Provide feedback to screen reader users on form errors]({{site.baseurl}}/docs/topics/forms/feedback/screen-reader-feedback/). 
