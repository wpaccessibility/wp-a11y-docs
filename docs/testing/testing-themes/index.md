...
Detailed testing instructions for each requirement can be found in the [Guidelines for the WordPress accessibility-ready tag]({{site.baseurl}}/docs/topics/theme-guidelines/).
