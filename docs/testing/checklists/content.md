...
- [Readability]({{site.baseurl}}/docs/topics/content/readability/)
...
Always give images proper alternative text using the W3C [alt decision tree](https://www.w3.org/WAI/tutorials/images/decision-tree/).
