...
The [WordPress theme accessibility guidelines]({{site.baseurl}}/docs/topics/theme-guidelines/) including testing instructions, so you can check your own theme.
...
**Note**: Want to get your theme listed as “Accessibility Ready” on the Themes Repo? See the [themes review handbook for more information]({{site.baseurl}}/docs/topics/theme-guidelines/). 
